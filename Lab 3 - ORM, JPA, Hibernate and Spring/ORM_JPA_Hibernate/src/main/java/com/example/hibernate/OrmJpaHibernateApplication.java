...
public class OrmJpaHibernateApplication {
	
	@Autowired
	static TestService ts;

	public static void main(String[] args) throws InterruptedException {
		ConfigurableApplicationContext applicationContext = SpringApplication.run(OrmJpaHibernateApplication.class, args);
		...
		System.out.println("Going to sleep fo 10 sec");
	    TimeUnit.SECONDS.sleep(10); //make sure cache is clear
